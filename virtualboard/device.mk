...
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,\
			...
			$(LOCAL_PATH)/init.virtualboard.rc:root/init.virtualboard.rc \
			$(LOCAL_PATH)/fstab.virtualboard:root/fstab.virtualboard \
			$(LOCAL_PATH)/ueventd.virtualboard.rc:root/ueventd.virtualboard.rc)
